...
//		System.out.println(TextDisplayedStatus);
		...
		//5. & 6. tagName & className  -->These are locating or identifying group of or multiple web elements
		...
		//6.tagName
		//List<WebElement> is a written type it means it shows when curser over on findElements it shows written type
